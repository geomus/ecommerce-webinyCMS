...
import { createProduct, uploadFile, products } from "../../../graphql/query";
...
export default function ProductForm({handleCloseDialog}) {
    ...
    const onSubmit = async (e) => {
        ...
        try {            
            ...
            setOpenSuccess(true);
            setTimeout(function(){ handleCloseDialog(false) }, 3000);
        } catch (error) {
            console.error(error);
            setOpenError(true);
            setIsLoading(false);
                    ...
                    <form onSubmit={onSubmit}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                ...
                                <FileUploadButton handlerImages={handleChangeImages} />
